...
void * copy_data_one_direction (void *_st) {
...
static void do_connect (const struct sockaddr *sap, socklen_t len) {
...
static void do_listen (const struct sockaddr *sap, socklen_t len) {
...
int get_address (struct sockaddr_storage *sa, char *host, char *port) {
